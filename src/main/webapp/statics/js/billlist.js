...
$(function(){
	$(".viewBill").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/bill/billview?method=view&billid="+ obj.attr("billid");
	});
	
	$(".modifyBill").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/bill/billModify?method=modify&billid="+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
	...
	$(".deleteBill").on("click",function(){
		billObj = $(this);
        //window.location.href=path+"/bill/delBillById?method=delete&billid="+ obj.attr("billid");
