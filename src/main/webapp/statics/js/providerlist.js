...
function deleteProvider(obj){
	$.ajax({
		type:"GET",
		url:path+"/provider/delProviderById",
		data:{method:"delProviderById",proid:obj.attr("proid")},
		dataType:"json",
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		//alert(obj);
		window.location.href=path+"/provider/getProviderById?method=view&proid="+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/provider/providerModify?method=modify&proid="+ obj.attr("proid");
	});
	...
	$(".deleteProvider").on("click",function(){
		providerObj = $(this);
        //window.location.href=path+"/provider/delProviderById?method=delete&proid="+ obj.attr("proid");
